...
def make_oxe_dataset_kwargs(
    ...
    if dataset_kwargs["action_encoding"] not in [ActionEncoding.EEF_POS, ActionEncoding.EEF_R6, ActionEncoding.HUMANOID_JOINT_DC, ActionEncoding.WALKER_JOINT, ActionEncoding.GO2_QUADRUPED_JOINT]:
    ...
    elif dataset_kwargs["action_encoding"] is ActionEncoding.HUMANOID_JOINT_DC:
        dataset_kwargs["absolute_action_mask"] = [False] * 19
        dataset_kwargs["action_normalization_mask"] = [True] * 19
    elif dataset_kwargs["action_encoding"] is ActionEncoding.WALKER_JOINT:
        dataset_kwargs["absolute_action_mask"] = [False] * 6
        dataset_kwargs["action_normalization_mask"] = [True] * 6
    elif dataset_kwargs["action_encoding"] is ActionEncoding.GO2_QUADRUPED_JOINT:
        dataset_kwargs["absolute_action_mask"] = [False] * 12
